...
class PlayingLectureTableView: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PlayingLectureCell") as! SelectedVideoCell
        var index:Int = 0;
